...
public class FindPredecessorResponseMessage extends Message {
	...
	public FindPredecessorResponseMessage(String from, String to,
			NodeID preHash, NodeID origHash) {
	...
	public String toString() {
		// Return message info
		return super.toString("MSG-PREDECESSOR_RESPONSE")
				+ " | predecessorKey: " + preHash.toString() + ") origHash: "
				+ origHash.toString();
	}
	...
	public static Message deserializeMessage(DataInputStream ois,
		...
		try {
			...
			return new FindPredecessorResponseMessage(fromIp, toIp, new NodeID(
					preHash), new NodeID(origHash));
		} catch (IOException e) {
			return null;
		}
	}
