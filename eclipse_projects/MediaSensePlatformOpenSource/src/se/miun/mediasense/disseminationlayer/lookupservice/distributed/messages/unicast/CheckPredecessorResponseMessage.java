...
public class CheckPredecessorResponseMessage extends Message {
	...
	public CheckPredecessorResponseMessage(String from, String to,
			String preNetworkAddress, NodeID preHash) {
	...
	public String toString() {
		// Return message info
		return super.toString("MSG-CHECK_PREDECESSOR_RESPONSE")
				+ " | preHash: " + preHash.toString() + " preAddr: ("
				+ preNetworkAddress.toString() + ")";
	}
	...
	public static Message deserializeMessage(DataInputStream ois,
		...
		try {
			...
			return new CheckPredecessorResponseMessage(fromIp, toIp, pna,
					new NodeID(hash));
		} catch (IOException e) {
			return null;
		}
