...
public class CheckSuccessorResponseMessage extends Message {
	...
	public CheckSuccessorResponseMessage(String from, String to,
	...
	public String toString() {
		// Return message info
		return super.toString("MSG-CHECK_SUCCESSOR_RESPONSE") + " | preHash: "
				+ sucHash.toString() + " preAddr: ("
				+ sucNetworkAddress.toString() + ")";
	}
	...
	public static Message deserializeMessage(DataInputStream ois,
		...
		try {
			...
			return new CheckSuccessorResponseMessage(fromIp, toIp, sna,
					new NodeID(hash));
		} catch (IOException e) {
			return null;
		}
