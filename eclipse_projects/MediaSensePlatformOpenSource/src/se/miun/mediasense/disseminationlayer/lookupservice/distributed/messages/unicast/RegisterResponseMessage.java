...
public class RegisterResponseMessage extends Message {
	...
	public RegisterResponseMessage(String from, String to, NodeID sensor,
			NodeID origHash) {
	...
	public String toString() {
		// Return message info
		return super.toString("MSG-REGISTER_RESPONSE") + " sensor: " + sensor
				+ " - origHash: " + origHash;
	}
	...
	public static Message deserializeMessage(DataInputStream ois,
		...
		try {
			...
			return new RegisterResponseMessage(fromIp, toIp,
					new NodeID(sensor), new NodeID(origHash));
		} catch (IOException e) {
			return null;
		}
	}
